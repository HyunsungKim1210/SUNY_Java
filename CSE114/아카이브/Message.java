...
public class Message {
    ...
    public Message(String mail, String email, String string, boolean returnReceiptRequested, String string1, String string2){
        this.from = "";
        this.to = "";
        this.date = "";
        this.subject = "";
    ...
    public void print (){
        ...
        System.out.println("body Length: " + getLength());
    }
