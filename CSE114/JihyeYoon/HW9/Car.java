...
public class Car implements Comparable<Car> {
    ...
    public int compareTo(Car otherCars) {
        int comparison = this.make.compareTo(otherCars.make);
        if (comparison != 0) {
            return comparison;
        }
        return this.model.compareTo(otherCars.model);
    }
    public static void main(String[] args) {
        ...
        System.out.println("Car3 Reliable: " + car2.isReliable());
        System.out.println("Car3 High Mileage: " + car2.isHighMilage());
        System.out.println("Car4 Reliable: " + car2.isReliable());
        System.out.println("Car4 High Mileage: " + car2.isHighMilage());
        ...
        System.out.println("Comparing Car2 to Car4: " + car2.compareTo(car4));
    }
}
